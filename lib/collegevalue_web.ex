defmodule CollegevalueWeb do
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CollegevalueWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/collegevalue_web/templates",
        namespace: CollegevalueWeb
  ...
  def live_view do
    quote do
      use Phoenix.LiveView,
        layout: {CollegevalueWeb.LayoutView, "live.html"}
